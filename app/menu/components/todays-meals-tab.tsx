      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6">
        ...
        {isLoading ? (
          <div className="text-center py-12">
            <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-purple-200 dark:border-[#3d2e10] border-t-purple-600 dark:border-t-[#C9A530]"></div>
            <p className="mt-4 text-gray-600 dark:text-gray-400">Loading your meals...</p>
          </div>
        ) : todaysMeals.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-6xl mb-4">🍽️</p>
            <p className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">No meals tracked yet today</p>
